...
- `soak` is read-only: it inspects the run ledger and optionally the user systemd timer state, run source, and git commit. It does not create artifacts, run providers, or mutate live memory.
