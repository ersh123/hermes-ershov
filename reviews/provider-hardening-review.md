...
Resolved by:
- `tests/test_providers.py::test_openai_compatible_provider_rejects_structured_proposed_text`
- `tests/test_providers.py::test_openai_compatible_provider_rejects_fabricated_provenance`
- `tests/test_provider_failure.py::test_create_dream_artifact_writes_failure_artifact_for_invalid_provider_output`

Historical verdict: STOP — the hardening still accepts malformed provider blobs and does not actually ground provenance in real sources.
